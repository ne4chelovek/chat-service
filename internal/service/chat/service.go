...
func NewService(chatRepository repository.ChatRepository, logRepository repository.LogRepository, api ClientApi.ApiCat, txManager db.TxManager) service.ChatService {
	return &serv{
