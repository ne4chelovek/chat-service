...
test:
	go clean -testcache
	go test ./... -covermode count -coverpkg=github.com/ne4chelovek/chat_service/internal/service/...,github.com/ne4chelovek/chat_service/internal/api/... -count 5


test-coverage:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/ne4chelovek/chat_service/internal/service/...,github.com/ne4chelovek/chat_service/internal/api/... -count 5
